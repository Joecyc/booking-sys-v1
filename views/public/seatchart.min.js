!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e =
        "undefined" != typeof globalThis ? globalThis : e || self).Seatchart =
        t());
})(this, function () {
  "use strict";
  var r = function (e, t) {
  ...
  var a,
    C =
      (e(n, (a = t)),
      (n.prototype.stateEventListener = function (e) {
        var t = e.current,
          n = t.index,
          r = t.state,
          a = t.label,
        ...
        this.index.row === n.row &&
          this.index.col === n.col &&
          ((this.element.textContent = a),
          (this.element.className = "sc-seat sc-seat-"
            .concat(r, " ")
            .concat(o.cssClass)));
      }),
      (n.prototype.seatClick = function () {
        ...
        if ("reserved" !== e.state && "disabled" !== e.state) {
          ...
          this.store.setSeat(e.index, { state: t }, !0);
        }
      }),
      n);
  function n(e, t) {
    ...
    return (
      ((n = a.call(this, r) || this).store = t),
      (n.index = e),
      (n.seatClick = n.seatClick.bind(n)),
      r.addEventListener("click", n.seatClick),
      (n.stateEventListener = n.stateEventListener.bind(n)),
      n.store.addEventListener("seatchange", n.stateEventListener, {
        index: e,
      }),
      n
    );
  ...
  function h(e, t) {
    ...
    for (
      var n = t.getOptions().map,
        i = "rows" === e ? n.rowSpacers : n.columnSpacers,
        r = "rows" === e ? n.rows : n.columns,
        o = "rows" === e ? t.getRowLabel : t.getColumnLabel,
        s = function (t) {
          var e = o(t),
            n = new l(e);
          if (
  ...
  function f(i) {
    ...
    if (
      ((f.className = "sc-map"),
      void 0 === (null == n ? void 0 : n.visible) || n.visible)
    ) {
      var m = new E("rows", i);
  ...
  var x,
    L =
      (e(T, (x = t)),
      (T.prototype.updateTotalText = function () {
  ...
  function T(e) {
    ...
    return (
      (t.currency = (null == r ? void 0 : r.currency) || "€"),
      t.updateTotalText(),
      (t.updateTotalText = t.updateTotalText.bind(t)),
      t.store.addEventListener("cartchange", t.updateTotalText),
      t.store.addEventListener("cartclear", t.updateTotalText),
      t.store.addEventListener("seatchange", t.updateTotalText),
      t
    );
  }
  var S,
  ...
  function k(e) {
    ...
    return (
      (a.className = "sc-cart-btn sc-cart-btn-submit"),
      (a.textContent = (null == r ? void 0 : r.submitLabel) || "Checkout"),
      (a.type = "button"),
      (a.onclick = function () {
        return e.submit();
      }),
  ...
  function P(e) {
    ...
    return (
      (n.className = "sc-cart-btn sc-cart-btn-delete"),
      (n.type = "button"),
      n.appendChild(t),
      (n.onclick = e),
      O.call(this, n) || this
  ...
  function _(e) {
    ...
    (r.className = "sc-cart-title"),
      (t.deleteAllClick = t.deleteAllClick.bind(t));
    ...
    return (
      ...
      (t.title = r),
      t.updateCartTitle(),
      (t.updateCartTitle = t.updateCartTitle.bind(t)),
      t.store.addEventListener("cartclear", t.updateCartTitle),
      t.store.addEventListener("cartchange", t.updateCartTitle),
      t
    );
  }
  var A,
    K =
      ...
      (F.prototype.update = function (e, t) {
        (this.element.className = "sc-ticket ".concat(t.cssClass)),
          (this.seatTypeContainer.textContent = t.label),
          (this.seatLabelContainer.textContent = e);
      }),
      F);
  function F(e, t) {
    var n = this,
      r = document.createElement("div");
    (r.className = "sc-ticket ".concat(t.cssClass)),
      (n = A.call(this, r) || this);
    var a = document.createElement("div");
    return (
      (a.className = "sc-ticket-stripes"),
      (n.seatLabelContainer = document.createElement("div")),
      (n.seatLabelContainer.textContent = e),
      (n.seatLabelContainer.className = "sc-ticket-seat-label"),
      (n.seatTypeContainer = document.createElement("div")),
      (n.seatTypeContainer.textContent = t.label),
      (n.seatTypeContainer.className = "sc-ticket-seat-type"),
      r.appendChild(a),
      r.appendChild(n.seatLabelContainer),
      r.appendChild(n.seatTypeContainer),
  ...
  var V,
    M =
      (e(B, (V = t)),
      (B.prototype.deleteClick = function () {
        this.store.setSeat(this.seatIndex, { state: "available" }, !0);
      }),
      (B.prototype.formatPrice = function (e) {
        return "".concat(this.currency).concat(e.toFixed(2));
      }),
      (B.prototype.update = function (e, t) {
        this.ticket.update(e, t),
          (this.seatPriceTd.textContent = this.formatPrice(t.price));
      }),
      B);
  function B(e, t) {
    var n = this,
    ...
    (n.currency = (null == s ? void 0 : s.currency) || "€"),
      (n.seatPriceTd = document.createElement("td")),
      (n.seatPriceTd.textContent = n.formatPrice(i.price)),
      (n.deleteClick = n.deleteClick.bind(n));
    var c = new I(n.deleteClick),
      l = document.createElement("td");
    return (
      l.appendChild(c.element),
      r.appendChild(o),
      r.appendChild(n.seatPriceTd),
      r.appendChild(l),
      (n.store = t),
      (n.seatIndex = a.index),
      n
  ...
  var D,
    G =
      ...
      (H.prototype.cartClearEventListener = function () {
        var t, e;
        try {
          for (var n = y(this.items), r = n.next(); !r.done; r = n.next())
            r.value.element.remove();
        } catch (e) {
          t = { error: e };
        } finally {
          try {
  ...
  function H(e) {
    ...
    return (
      (n.className = "sc-cart-table"),
      ((t = D.call(this, n) || this).store = e),
      (t.items = []),
      (t.cartChangeEventListener = t.cartChangeEventListener.bind(t)),
      (t.cartClearEventListener = t.cartClearEventListener.bind(t)),
      (t.seatChangeEventListener = t.seatChangeEventListener.bind(t)),
      t.store.addEventListener("cartchange", t.cartChangeEventListener),
      t.store.addEventListener("cartclear", t.cartClearEventListener),
      t.store.addEventListener("seatchange", t.seatChangeEventListener),
      t
    );
  }
  var J,
  ...
  function Y(e, t) {
    ...
    return (
      (a.className = "sc-legend-description"),
      (a.textContent = e),
      n.appendChild(r),
      n.appendChild(a),
      W.call(this, n) || this
    ...
    ee =
      ((te.prototype.init = function () {
          ...
          for (
            var i = function (e) {
                var t = { row: u, col: e },
                  n = m({}, p.seats[u][e]),
                  r = "available";
                (null == c ? void 0 : c.some(p.isSameSeat(t)))
                  ? (r = "disabled")
                  : (null == l ? void 0 : l.some(p.isSameSeat(t)))
                  ? (r = "reserved")
                  : (null == d ? void 0 : d.some(p.isSameSeat(t))) &&
                    (r = "selected");
                var a = p.getSeatLabel(t),
                  i = p.getSeatType(t);
                p.seats[u][e] = { index: t, label: a, state: r, type: i };
                var o = p.seats[u][e],
                  s = p.listenerKey(t);
                p.singleSeatChangeEventListeners[s].forEach(function (e) {
                  return e({ previous: n, current: o });
                }),
        ...
        if (d) {
          var s = function (e) {
              ...
              h.cart.push(t),
                h.eventListeners.cartchange.forEach(function (e) {
                  return e({ action: "add", seat: t });
                });
            },
            h = this;
          try {
      ...
      (te.prototype.setSeat = function (e, t, n) {
        ...
        if (
          (i.state !== t.state &&
            ("selected" === o.state
              ? this.addToCart(o.index, n)
              : "selected" === i.state && this.removeFromCart(o.index, n)),
      ...
      (te.prototype.clearCart = function (e) {
        ...
        if (e) {
          0 < i.length &&
            this.eventListeners.cartclear.forEach(function (e) {
              return e({ seats: i });
            });
          var c = function (t) {
              l.eventListeners.cartchange.forEach(function (e) {
                return e({ action: "remove", seat: t });
              });
              var n = m(m({}, t), { state: "selected" }),
                e = l.listenerKey(t.index);
              l.singleSeatChangeEventListeners[e].forEach(function (e) {
                return e({ previous: n, current: t });
              }),
      ...
      (te.prototype.getCartTotal = function () {
        var t,
          e,
          n = this.options.map.seatTypes,
          r = 0;
        try {
          for (var a = y(this.cart), i = a.next(); !i.done; i = a.next())
            r += n[i.value.type].price;
        } catch (e) {
          t = { error: e };
        } finally {
          try {
      ...
      (te.prototype.getRowLabel = function (e) {
        var t,
          n =
            null === (t = this.options.map.indexerRows) || void 0 === t
              ? void 0
              : t.label;
        if (n) return n(e);
      ...
      (te.prototype.getColumnLabel = function (e) {
        var t,
          n =
            null === (t = this.options.map.indexerColumns) || void 0 === t
              ? void 0
              : t.label;
      ...
      (te.prototype.removeEventListener = function (e, t, n) {
        if (n) {
          var r = this.listenerKey(n.index);
          this.singleSeatChangeEventListeners[r] =
            this.singleSeatChangeEventListeners[r].filter(function (e) {
              return e !== t;
            });
        } else
      ...
      (te.prototype.validateIndex = function (e) {
        if (
          e.row < 0 ||
          e.col < 0 ||
          e.row >= this.options.map.rows ||
          e.col >= this.options.map.columns
        )
          throw RangeError("Seat index is out of range");
      }),
      (te.prototype.validateType = function (e) {
        if (void 0 !== e && !this.options.map.seatTypes[e])
        ...
        try {
          for (var c = y(s), l = c.next(); !l.done; l = c.next()) {
            var d = l.value,
              u = o[d];
            if (
              (null === (r = u.seats) || void 0 === r
                ? void 0
                : r.some(this.isSameSeat(t))) ||
              (null === (a = u.seatColumns) || void 0 === a
                ? void 0
                : a.some(function (e) {
                    return e === t.col;
                  })) ||
              (null === (i = u.seatRows) || void 0 === i
                ? void 0
                : i.some(function (e) {
                    return e === t.row;
                  }))
  ...
  function te(e) {
    ...
    for (var t = e.map, n = t.rows, r = t.columns, a = 0; a < n; a++)
      for (var i = 0; i < r; i++) {
        var o = this.listenerKey({ row: a, col: i });
  ...
  function ne(e, t) {
    (this.element = e),
      (this.options = t),
      (this.store = new ee(t)),
      (this.ui = new $(e, this.store)),
      this.store.init();
  }
  return (
    (ne.prototype.addEventListener = function (e, t) {
